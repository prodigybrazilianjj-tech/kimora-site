    ...
    <section className="py-24 bg-background">
      <div className="container px-4 mx-auto max-w-3xl">
        ...
        <div className="space-y-8 mb-12">
          <div>
            <h3 className="text-lg font-bold text-foreground mb-2">Do I need to load creatine?</h3>
            <p className="text-muted-foreground">No. Just take one 5 g stick daily and let your levels build over time.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold text-foreground mb-2">When should I take it?</h3>
