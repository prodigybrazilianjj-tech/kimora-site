...
export function ProductLineup() {
  return (
    <section
      id="flavors"
      // ✅ This is the clean fix: offset anchor handled by CSS (no spacer div)
      // Nav height is 72px; we give a little breathing room.
      className="py-12 md:py-16 bg-background relative overflow-hidden scroll-mt-[92px] md:scroll-mt-[104px]"
    >
