  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#040404] text-white">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[-4rem] hidden w-[48rem] max-w-none -translate-x-1/2 opacity-[0.035] lg:block"
      />
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-5 md:px-8 lg:px-10">
          <div className="flex items-center gap-3">
            <img
              src="/assets/products/enso_tentacle.png"
              alt="Kimora Co."
              className="h-10 w-auto brightness-[1.05] contrast-125"
            />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,660px)_1fr] lg:gap-16">
            <div className="relative max-w-[660px]">
              <img
                ...
                alt=""
                aria-hidden="true"
                className="pointer-events-none absolute -left-10 top-6 hidden w-[520px] max-w-none opacity-[0.045] brightness-[1.05] contrast-125 lg:block"
              />
