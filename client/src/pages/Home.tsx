...
/**
 * The homepage — the page kimoraco.com has served at "/" since the pre-launch
 * front door went up, now under its real name. (It was ComingSoon.tsx until
 * 2026-09-09; the parked "dynamic refresh" Home was retired the same day.)
 * While PRELAUNCH_GATE is on nothing is buyable, so the hero still asks for
 * the waitlist; flip the gate to launch.
 */
    ...
    <>
      <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground">
        ...
        <main className="relative z-10">
          ...
          {/* ── 2. The stick and its numbers — cream, gold rules top + bottom ── */}
          <StatsBand tone="cream" rules product />
