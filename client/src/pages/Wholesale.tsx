      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-3 text-sm text-white/55 max-w-3xl mx-auto">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/wholesale/apply">
                <Button className="h-12 px-6 bg-primary hover:bg-primary/90 text-white font-bold uppercase tracking-wider">
                  Apply Now
                </Button>
              </Link>
              ...
              <Link href="/shop">
                <Button
                  variant="secondary"
                  className="h-12 px-6 bg-white/10 hover:bg-white/20 text-white"
                >
                  Shop Retail
                </Button>
              </Link>
          ...
          {/* Program Overview */}
          <div className="rounded-2xl border border-white/10 bg-black/30 p-8 mb-10">
            <h2 className="text-2xl font-display font-bold text-white mb-3 text-center">
              Wholesale Program Overview
            </h2>
            <p className="text-sm text-white/70 max-w-3xl mx-auto text-center leading-relaxed">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/30 p-8 mb-10">
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                <div className="text-white font-semibold mb-1">What is the retail price?</div>
                <p className="text-sm text-white/70 leading-relaxed">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                <div className="text-white font-semibold mb-1">Is there a minimum order?</div>
                <p className="text-sm text-white/70 leading-relaxed">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                <div className="text-white font-semibold mb-1">Can I sell Kimora online?</div>
                <p className="text-sm text-white/70 leading-relaxed">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                <div className="text-white font-semibold mb-1">Do you offer exclusivity?</div>
                <p className="text-sm text-white/70 leading-relaxed">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                <div className="text-white font-semibold mb-1">How fast do orders ship?</div>
                <p className="text-sm text-white/70 leading-relaxed">
          ...
          <div className="text-center rounded-2xl border border-white/10 bg-white/5 p-10">
            ...
            <div className="mt-6 flex justify-center">
              <Link href="/wholesale/apply">
                <Button className="h-12 px-8 bg-primary hover:bg-primary/90 text-white font-bold uppercase tracking-wider">
                  Apply Now
                </Button>
              </Link>
            </div>
